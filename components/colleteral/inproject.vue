...
const form = ref({
  title: "ເພີ່ມຫຼັກຊັບ ທີ່ດິນໃນໂຄງການສຳປະທານ",
  type: "create",
});
...
const ColView = async (val) => {
  ...
  modalVal.value = true;
  form.value.title = "ຂໍ້ມູນຫຼັກຊັບ ທີ່ດິນໃນໂຄງການສຳປະທານ";
  form.value.type = "update";
  rcol.name = ref(val.name);
  rcol.doc_no = ref(val.doc_no);
  ...
  rcol.value = val.value;
  rcol.ccy = val.ccy;
  rcol.pi_value = val.pi_value;
  rcol.ccy_pi = ref(val.ccy);
  rcol.cur_value = ref(val.cur_value);
  rcol.ccy_cur = ref(val.ccy);
    ...
    <div class="overflow-x-auto">
      <table class="table table-compact w-full">
        <thead>
          <tr>
            <th>seq</th>
            <th>ຊື່ໂຄງການສຳປະທານ</th>
            <th>ເລກທີ</th>
            <th>ລົງວັນທີ</th>
            <th>ມື້ໝົດສັນຍາໂຄງການ</th>
            <th>ສະກຸນເງິນ</th>
            <th class="text-right">ມູນຄ່າໂຄງການສຳປະທານ</th>
          ...
          <div class="sticky top-0 bg-base-100 z-9 px-5 pt-3">
            <button
              @click="
                modalVal = false;
                form.type = 'create';
                form.title = 'ເພີ່ມຫຼັກຊັບ ທີ່ດິນໃນໂຄງການສຳປະທານ';
              "
            ...
            <form @submit="handleSubmit($event, CreateColleteral)" class="mt-4">
              <div class="mt-1">
                <label
                  ...
                  >ຊື່ໂຄງການສຳປະທານ <span class="text-[red]">*</span></label
                >
                <VField
                  type="text"
                  name="name"
              ...
              <div class="flex gap-2 w-full mt-1">
                ...
                <div class="w-full">
                  <label
                    for="colExpire"
                    class="block mb-2 text-sm font-medium dark:text-gray-300"
                    >ມື້ໝົດສັນຍາ <span class="text-[red]">*</span></label
                  >
                  <VField
                    type="date"
                    name="expire_date"
